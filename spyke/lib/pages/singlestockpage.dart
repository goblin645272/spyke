...
class _SingleStockPageState extends State<SingleStockPage> {
  ...
  loadnewsdata() async {
    String ur =
        "https://testingspyke.herokuapp.com/scrapenews?search=${widget.companyname}";
        ...
        new FlatButton(
          onPressed: () async {
            if (await LocalTickerList.instance
              ...
              return Fluttertoast.showToast(msg: 'Failed to delete Data');
            }

            Navigator.of(context).pop();
          },
          textColor: Theme.of(context).primaryColor,
          child: const Text('Delete stock from your watchlist'),
        ),
      ],
    );
  }
  ...
  Widget _deltaInfoDialog(BuildContext context) {
    return new AlertDialog(
      title: const Text('What is delta?'),
      content: new Column(
        mainAxisSize: MainAxisSize.min,
        crossAxisAlignment: CrossAxisAlignment.start,
        children: <Widget>[
          Text(
              " Delta is the minimum amount of change from the current price that you want us to monitor.\n E.g. if current price is Rs. 250.00 and you want us to notify you when the stock touches Rs. 270, your delta is Rs. 20. \n It is recommended to put your delta atmost 5% range of your current price."),
        ],
      ),
      actions: <Widget>[
        new FlatButton(
